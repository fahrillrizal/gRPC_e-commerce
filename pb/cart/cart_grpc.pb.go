...
const (
	...
	CartService_UpdateCartQty_FullMethodName = "/cart.CartService/UpdateCartQty"
)
...
type CartServiceClient interface {
	...
	UpdateCartQty(ctx context.Context, in *UpdateCartQtyRequest, opts ...grpc.CallOption) (*UpdateCartQtyResponse, error)
}
...
func (c *cartServiceClient) UpdateCartQty(ctx context.Context, in *UpdateCartQtyRequest, opts ...grpc.CallOption) (*UpdateCartQtyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateCartQtyResponse)
	err := c.cc.Invoke(ctx, CartService_UpdateCartQty_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CartServiceServer interface {
	...
	UpdateCartQty(context.Context, *UpdateCartQtyRequest) (*UpdateCartQtyResponse, error)
...
func (UnimplementedCartServiceServer) UpdateCartQty(context.Context, *UpdateCartQtyRequest) (*UpdateCartQtyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateCartQty not implemented")
}
...
func _CartService_UpdateCartQty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateCartQtyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CartServiceServer).UpdateCartQty(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CartService_UpdateCartQty_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).UpdateCartQty(ctx, req.(*UpdateCartQtyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateCartQty",
			Handler:    _CartService_UpdateCartQty_Handler,
		},
	},
